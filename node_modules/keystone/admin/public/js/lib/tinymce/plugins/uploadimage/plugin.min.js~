  ...
  tinymce.create('tinymce.plugins.UploadImage', {
    UploadImage: function(ed, url) {
      ...
      function showDialog() {
        win = editor.windowManager.open({
          title: ed.translate('Insert an image'),
          ...
          body: [
            ...
            {type: 'textbox', name: 'file', label: ed.translate('Image to upload'), subtype: 'file'},
	    {type: 'textbox', classes:'remote', name: 'remote', label: ed.translate('Or, URL of image to save')},
	...
	var temp=0;
      ...
      function insertImage() {
        if( (getInputValue("file") == "") && (getInputValue("remote") == "")) {
		alert(getInputValue("remote"));
