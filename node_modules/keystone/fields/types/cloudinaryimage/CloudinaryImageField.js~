...
module.exports = Field.create({
	...
	getImageFromURL: function() {
		//this.state.origin = 'local';

		this.props.value.url = $('#remote').val();
	...
	changeImage: function() {
		...
		//this.props.value.url = 'http://dustbridge.com/quiz/q29_a1.jpg';
	...
	renderImagePreview: function() {
		...
		if (url) {
			body = <a className='img-thumbnail' href={this.getImageSource()}>{body}</a>;
		} else {
	...
	renderUI: function() {
		var container = [],
			...
			fieldClassName = 'field-ui field-ui-small';
		...
		return (
			<div className='field field-type-cloudinaryimage'>
				...
				<input type='text' name='remote' id='remote' className='form-control input-url-field'/>
				<button type='button' className='btn btn-link image-button-right' onClick={this.getImageFromURL}> Save from URL</button>
