		...
		#wrap
			...
			#body: .container
				...
				if list.key == 'PostCategory'
					p NOTE to contributors: <strong>DON'T Add Or Change Anything Here!</strong> You probably want to add or choose a <a href="http://dailyinteresting.com/keystone/post-topics">Post Topic</a> instead. Categories affect how the site works; Topics are things like 'Science' or 'Music'.
				block content
