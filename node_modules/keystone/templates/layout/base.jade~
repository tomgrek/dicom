	...
	body(id='page-' + page)
		#wrap
			...
			#body: .container
				...
				if list.key == 'PostTopic'
					p NOTE to contributors: See <a href="https://materialdesignicons.com" target="_blank">materialdesignicons.com</a> for <strong>icon names</strong>.
				if list.key == 'PostCategory'
					p NOTE to contributors: <strong>DON'T Add Or Change Anything Here!</strong> You probably want to add or choose a <a href="http://dailyinteresting.com/keystone/post-topics" target="_blank">Post Topic</a> instead. Categories affect how the site works; Topics are things like 'Science' or 'Music'.
				block content
